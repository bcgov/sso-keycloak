...
- In Silver
  ...
  | IDIR Username           | idir_username          | preferred_username  | preferred_username=`{{username}}@idir` | preferred_username            |
...
- In Silver
  ...
  | Email                   | email                  | email               | email                                         | email                         |
  | Display Name            | display_name           | displayName         | displayName                                   | display_name                  |
  | BCeID Username          | bceid_username         | preferred_username  | preferred_username=`{{username}}@bceid-basic` | preferred_username            |
...
- In Gold
  ...
  | Email                                 | email                  | email               | email                                               | email                         |
  | Display Name                          | display_name           | display_name        | display_name                                        | display_name                  |
  | Display Name                          | display_name           | display_name        | first_name                                          | first_name                    |
  | BCeID Username                        | bceid_username         | bceid_username      | bceid_username                                      | bceid_username                |
  | BCeID Username                        | bceid_username         | bceid_username      | last_name                                           | last_name                     |
...
- In Silver
  ...
  | BCeID Username          | bceid_username          | preferred_username  | preferred_username=`{{username}}@bceid-business` | preferred_username=`{{username}}@bceid-business` |
...
- In Silver
  ...
  | BCeID Business Guid     | SMGOV_BUSINESSGUID      | bceid_business_guid | bceid_business_guid                                        | bceid_business_guid                                        |
  | BCeID Business Name     | SMGOV_BUSINESSLEGALNAME | bceid_business_name | bceid_business_name                                        | bceid_business_name                                        |
  | BCeID Username          | username                | preferred_username  | preferred_username=`{{username}}@bceid-basic-and-business` | preferred_username=`{{username}}@bceid-basic-and-business` |
