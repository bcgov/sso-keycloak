...
!(function (t, e) {
  ...
  function I(t) {
    var e = m();
    return (
      !0 === t ? (e.className = 'tippy-arrow') : ((e.className = 'tippy-svg-arrow'), g(t) ? e.appendChild(t) : V(e, t)),
      e
    );
  }
  function S(t, e) {
    g(e.content)
      ...
      : 'function' != typeof e.content && (e.allowHTML ? V(t, e.content) : (t.textContent = e.content));
  }
  function B(t) {
  ...
  function N(t) {
    ...
    function o(n, r) {
      ...
      r.theme ? i.setAttribute('data-theme', r.theme) : i.removeAttribute('data-theme'),
        ...
        r.arrow
          ? s
            ? n.arrow !== r.arrow && (i.removeChild(s), i.appendChild(I(r.arrow)))
  ...
  function z(e, a) {
    var p,
      ...
      Y = {
        ...
        setProps: function (t) {
          ...
          (Y.props = r),
            ht(),
            n.interactiveDebounce !== r.interactiveDebounce && (pt(), (F = u(wt, r.interactiveDebounce)));
        ...
        show: function () {
          ...
          (L = function () {
            ...
            if (Y.state.isVisible && !N) {
              if (
                ((N = !0), $.offsetHeight, ($.style.transition = Y.props.moveTransition), tt() && Y.props.animation)
              ) {
                var e = rt(),
                  n = e.box,
                  r = e.content;
    ...
    function ot(t) {
      return (Y.state.isMounted && !Y.state.isVisible) || T.isTouch || (y && 'focus' === y.type)
        ? 0
    ...
    function ut() {
      !K &&
        ...
        c(Y.props.triggerTarget || e).forEach(function (t) {
          Y.props.interactive
            ? t.setAttribute('aria-expanded', Y.state.isVisible && t === et() ? 'true' : 'false')
            : t.removeAttribute('aria-expanded');
        });
    }
    function pt() {
    ...
    function Et(t) {
      (Y.props.trigger.indexOf('focusin') < 0 && t.target !== et()) ||
        (Y.props.interactive && t.relatedTarget && $.contains(t.relatedTarget)) ||
        Dt(t);
    }
    function Ot(t) {
      ...
      return {
        ...
        onAfterUpdate: function (e, n) {
          ...
          r ||
            (void 0 !== i &&
              a.followCursor !== i &&
              (d(), i ? (l(), !t.state.isMounted || o || s() || u()) : (p(), c())));
        },
        onMount: function () {
  ...
  var Q = {
    ...
    fn: function (t) {
      ...
      function a() {
        var s = r('reference')
            ? (t.popperInstance ? t.popperInstance.state.elements.reference : e).getBoundingClientRect()
            : null,
