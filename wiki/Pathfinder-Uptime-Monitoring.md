...
## Example Messaging
 ...
 - The Gold Keycloak _environment_  instance is in the process of failing over to the DR cluster
 ...
 - The Gold Keycloak  _environment_  instance has failed over to the DR cluster
 ...
 - The Gold Keycloak  _environment_  instance has been restored to the Primary cluster (aka back to normal).
