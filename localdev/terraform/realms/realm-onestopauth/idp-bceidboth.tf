...
resource "keycloak_oidc_identity_provider" "onestopauth_bceidboth" {
...
resource "keycloak_custom_identity_provider_mapper" "onestopauth_bceidboth_mapper_displayname" {
  realm                    = keycloak_realm.this.id
  name                     = "display_name"
  identity_provider_alias  = keycloak_oidc_identity_provider.onestopauth_bceidboth.alias
...
resource "keycloak_custom_identity_provider_mapper" "onestopauth_bceidboth_mapper_bceid_userid" {
  realm                    = keycloak_realm.this.id
  name                     = "bceid_userid"
  identity_provider_alias  = keycloak_oidc_identity_provider.onestopauth_bceidboth.alias
  identity_provider_mapper = "oidc-user-attribute-idp-mapper"
