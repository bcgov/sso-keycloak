...
resource "keycloak_saml_identity_provider" "bceidbusiness" {
  ...
  alias        = local.bceidbusiness_idp_name
  ...
  entity_id                  = "${var.keycloak_url}/auth/realms/${local.bceidbusiness_idp_name}"
...
resource "keycloak_custom_identity_provider_mapper" "bceidbusiness_mapper_email" {
  realm                    = keycloak_realm.this.id
  name                     = "email"
...
resource "keycloak_custom_identity_provider_mapper" "bceidbusiness_mapper_bceid_user_guid" {
  realm                    = keycloak_realm.this.id
...
resource "keycloak_custom_identity_provider_mapper" "bceidbusiness_mapper_bceid_user_name" {
  realm                    = keycloak_realm.this.id
...
resource "keycloak_custom_identity_provider_mapper" "bceidbusiness_mapper_bceid_business_guid" {
  realm                    = keycloak_realm.this.id
...
resource "keycloak_custom_identity_provider_mapper" "bceidbusiness_mapper_bceid_business_name" {
  realm                    = keycloak_realm.this.id
...
# resource "keycloak_custom_identity_provider_mapper" "bceidbusiness_mapper_username" {
#   realm                    = keycloak_realm.this.id
#   name                     = "username"
#   identity_provider_alias  = keycloak_saml_identity_provider.bceidbusiness.alias
