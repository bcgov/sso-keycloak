...
resource "keycloak_saml_identity_provider" "bceidboth" {
  ...
  alias        = local.bceidboth_idp_name
  ...
  entity_id                  = "${var.keycloak_url}/auth/realms/${local.bceidboth_idp_name}"
...
resource "keycloak_custom_identity_provider_mapper" "bceidboth_mapper_displayname" {
  realm                    = keycloak_realm.this.id
  name                     = "display_name"
...
resource "keycloak_custom_identity_provider_mapper" "bceidboth_mapper_email" {
  realm                    = keycloak_realm.this.id
  name                     = "email"
  identity_provider_alias  = keycloak_saml_identity_provider.bceidboth.alias
  identity_provider_mapper = "saml-user-attribute-idp-mapper"
...
resource "keycloak_custom_identity_provider_mapper" "bceidboth_mapper_bceid_user_guid1" {
  realm                    = keycloak_realm.this.id
...
resource "keycloak_custom_identity_provider_mapper" "bceidboth_mapper_bceid_user_guid2" {
  realm                    = keycloak_realm.this.id
...
resource "keycloak_custom_identity_provider_mapper" "bceidboth_mapper_bceid_user_name" {
  realm                    = keycloak_realm.this.id
...
resource "keycloak_custom_identity_provider_mapper" "bceidboth_mapper_bceid_business_guid" {
  realm                    = keycloak_realm.this.id
...
resource "keycloak_custom_identity_provider_mapper" "bceidboth_mapper_bceid_business_name" {
  realm                    = keycloak_realm.this.id
...
# resource "keycloak_custom_identity_provider_mapper" "bceidboth_mapper_username" {
#   realm                    = keycloak_realm.this.id
#   name                     = "username"
#   identity_provider_alias  = keycloak_saml_identity_provider.bceidboth.alias
